...
_G.TabThemeColor = Color3.fromRGB(0, 0, 255)
...
_G.SectionOn = Color3.fromRGB(0, 0, 255)
...
function Blacklib:Window(gametitle)
   ...
   -- Shadow.Image = "http://www.roblox.com/asset/?id=6105530152"
    ...
    BlackImage.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
    BlackImage.BackgroundTransparency = 1.000
    BlackImage.Position = UDim2.new(0, 5, 0, 7)
    BlackImage.Size = UDim2.new(0, 25, 0, 25)
   -- BlackImage.Image = "rbxthumb://type=Asset&id=5107182114&w=150&h=150"
    BlackImage.ImageColor3 = Color3.fromRGB(0, 0, 255)
    ...
    Space.Text = "|"
    Space.TextColor3 = Color3.fromRGB(0, 0, 255)
    ...
    MinButton.TextColor3 = Color3.fromRGB(0, 0, 255)
    MinButton.Text = "-"
    ...
    CloseButton.TextColor3 = Color3.fromRGB(0, 0, 255)
    CloseButton.Text = "×"
  ...
  --  CloseImage.Image = "rbxthumb://type=Asset&id=5107182114&w=150&h=150"
    CloseImage.ImageColor3 = Color3.fromRGB(0, 0, 255)
    ...
    ServerTime.TextColor3 = Color3.fromRGB(0, 0, 255)
    ...
    ServerDate.TextColor3 = Color3.fromRGB(0, 0, 255)
    ...
    PlaLab.Text = "Thanks for using Project Vision"
    PlaLab.TextSize = 13.000
    PlaLab.TextColor3 = Color3.fromRGB(0, 0, 255)
    ...
    spawn(function()
        while task.wait() do
            titlefunc:Refresh("") wait(.2) titlefunc:Refresh("P") wait(.2) titlefunc:Refresh("ro") wait(.2) titlefunc:Refresh("ject Vision") wait(.2) titlefunc:Refresh("Project") wait(.2) titlefunc:Refresh("Project Vision") wait(.2) titlefunc:Refresh("Project Vision") wait(.2) titlefunc:Refresh("") wait(.2) titlefunc:Refresh("") wait(.2) titlefunc:Refresh("") wait(.9) titlefunc:Refresh("") wait(.2) titlefunc:Refresh("") wait(.2) titlefunc:Refresh("") wait(.2) titlefunc:Refresh("") wait(.2) titlefunc:Refresh("") wait(.2) titlefunc:Refresh("") wait(.2) titlefunc:Refresh(" ") wait(.2) titlefunc:Refresh(" ") wait(.2) titlefunc:Refresh("") wait(.2) wait(.3)
        end
    end)
    -- End Windows --
    ...
    function Tabs:Tab(tabtitle, img)
      ...
      --  TabImage.Image = img or "rbxthumb://type=Asset&id=5107182114&w=150&h=150"
        ...
        function Section:NewSection(seclabel)
            ...
            closeSection.MouseButton1Click:Connect(function()
                if isDropped then
                    ...
                    game.TweenService:Create(closeSection, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(0, 0, 255)}):Play()
                    game.TweenService:Create(sectionCircle, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(0, 0, 255)}):Play()
                    game.TweenService:Create(TextLabel, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(0, 0, 255)}):Play()
                    wait(0.10)
                    UpdateSize()
                end
            end)
          ...
          --      ImageLabel.Image = "rbxassetid://8825007757"
                ...
                Title_2.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
